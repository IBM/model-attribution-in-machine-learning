...
class MLMATPayloadSelection(gym.Env):
    ...
    def step(self, action):
        ...
        if int(self.base_model_to_training_ft[self.base_model]) == int(self.ft) and int(classification) == 1:
            self.reward += 1
        elif int(self.base_model_to_training_ft[self.base_model]) != int(self.ft) and int(classification) == 0:
            self.reward += 1
        else:
            self.reward += -10
