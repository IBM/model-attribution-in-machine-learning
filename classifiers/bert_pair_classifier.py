...
base_model_to_training_ft = {"bloom-350m": '0', "opt-350m": '1', "DialoGPT-large": '2', "distilgpt2": '3', "gpt2-xl": '4', "gpt2": '5',
                    "gpt-neo-125M": '6',  "xlnet-base-cased": '7',"Multilingual-MiniLM-L12-H384": '8',
                    "codegen-350M-multi": '9'}
...
for base_model in base_model_to_training_ft.keys():
    ...
    torch.save(model.state_dict(), f'./files/bert_pair_{base_model}_classifier/model.pth')
    ...
    filename = f'../files/bert_pair_{base_model}_classifier/test_results.json'
